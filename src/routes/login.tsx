...
function Login() {
  ...
  const fieldCls = (key: string) =>
    'demo-input has-icon pl-9 pr-3' + (errors[key] ? ' border-red-500' : '')
      ...
      <div className="brand-panel relative hidden flex-col justify-between overflow-hidden p-12 text-white lg:flex">
        ...
        <div className="relative max-w-md">
          ...
          <p className="mt-4 leading-relaxed text-white/80">
            Sign in to DocPro and get answers from your contracts, invoices, and
            policies — complete with source citations.
          </p>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="card p-6 sm:p-8">
            ...
            <div className="mb-6 inline-flex w-full rounded-lg bg-[var(--muted)] p-0.5 text-sm">
              <button className="seg-active flex-1 rounded-md px-3 py-2 text-center font-medium">Sign In</button>
              <Link to="/register" className="flex-1 rounded-md px-3 py-2 text-center text-[var(--fg-soft)]">
                Register
              </Link>
            </div>
            ...
            {/* Heading */}
            <div className="mb-6">
              <h2 className="text-2xl font-semibold tracking-tight">Sign in to DocPro</h2>
              <p className="mt-1 text-sm text-[var(--mutfg)]">Welcome back. Continue exploring your Knowledge.</p>
            </div>
            ...
            <form className="space-y-4" onSubmit={handleSubmit} noValidate>
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-xs text-[var(--mutfg)]">or sign in with email</span>
                <div className="h-px flex-1 bg-slate-200" />
              </div>
